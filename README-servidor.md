...
criação do usuário administrador. Depois, o admin cria os demais usuários
(`POST /api/usuarios` — tela de administração é evolução futura; enquanto
isso, cada usuário pode ser criado pelo admin via ferramenta da equipe).
...
- `auditoria_web.db` — usuários e sessões de login
